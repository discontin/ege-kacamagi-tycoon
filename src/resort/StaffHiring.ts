...
export const STAFF_AREAS = [
  ...
  // Outside the laundry in the clear lower tile requested by the player.
  { id: 'haulingHire', target: 'haulingWorker', role: 'hauling', label: 'Çamaşırhane görevlisi', x: 13, y: 50 },
